...
normaldata = load_data(r'/mnt/d/Study_File/codezcy/DANN-zcy-main/MKGLMFA/MFPTdata/base_1_overlap.txt')
outer100data = load_data(r'/mnt/d/Study_File/codezcy/DANN-zcy-main/MKGLMFA/MFPTdata/outer_100_overlap.txt')
outer200data = load_data(r'/mnt/d/Study_File/codezcy/DANN-zcy-main/MKGLMFA/MFPTdata/outer_200_overlap.txt')
inner0data = load_data(r'/mnt/d/Study_File/codezcy/DANN-zcy-main/MKGLMFA/MFPTdata/inner_0_overlap.txt')
inner300data = load_data(r'/mnt/d/Study_File/codezcy/DANN-zcy-main/MKGLMFA/MFPTdata/inner_300_overlap.txt')
